...
MAPPA_ASSET = {
    ...
    # ETF / ETC (Versioni stabili per Yahoo)
    "CSSPX.MI": {"mt5": "S&P500", "cat": "🇮🇹 ETF USA", "tv": "MIL:CSSPX"},
    "ANX.MI":   {"mt5": "NAS100", "cat": "🇮🇹 ETF TECH", "tv": "MIL:ANX"}, 
    "DAX2ST.MI": {"mt5": "GER40", "cat": "🇮🇹 ETF DAX", "tv": "MIL:DAX2ST"},
    "ETFMIB.MI": {"mt5": "ITA40", "cat": "🇮🇹 ETF MIB", "tv": "MIL:ETFMIB"},
    "SWDA.MI": {"mt5": "WORLD", "cat": "🌍 ETF WORLD", "tv": "MIL:SWDA"},
    ...
    "CRUD.MI": {"mt5": "OIL", "cat": "🛢️ ETC OIL", "tv": "MIL:CRUD"},

    # CRYPTO ETP (XETRA)
    "BTCE.DE": {"mt5": "BTC", "cat": "🌐 CRYPTO ETP", "tv": "XETR:BTCE"},
    "ETHE.DE": {"mt5": "ETH", "cat": "🌐 CRYPTO ETP", "tv": "XETR:ETHE"},
    "VBTC.DE": {"mt5": "BTC", "cat": "🌐 CRYPTO ETP", "tv": "XETR:VBTC"},

    # FOREX & COMMODITIES
    "EURUSD=X": {"mt5": "EURUSD", "cat": "💱 FOREX", "tv": "FX:EURUSD"},
    "GBPUSD=X": {"mt5": "GBPUSD", "cat": "💱 FOREX", "tv": "FX:GBPUSD"},
    "KC=F": {"mt5": "COFFEE", "cat": "🌾 SOFT COMM", "tv": "KC1!"}
}

CORRELAZIONI = {
    "CSSPX.MI": "^GSPC", "ANX.MI": "^NDX", "DAX2ST.MI": "^GDAXI",
    "ETFMIB.MI": "FTSEMIB.MI", "SGLD.MI": "GC=F", "PHAG.MI": "SI=F",
    "BTCE.DE": "BTC-USD", "CRUD.MI": "CL=F", "IK00.MI": "FTSEMIB.MI"
}
        ...
        try:
            ...
            if distanza < SOGLIA_NOTIFICA:
                ...
                if is_nuovo or is_migliorato:
                    ...
                    mpf.plot(plot_data, type='candle', style='charles', savefig='plot.png', alines=alines, title=f"{ticker} (4h)")
